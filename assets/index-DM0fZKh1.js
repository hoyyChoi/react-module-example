...
const C = /^[0-9]*$/, E = {
  ...
  const { state: e, onChange: t, isLengthComplete: s } = g({
    initialState: "",
    maxLength: l.CVC_NUMBER
  }), { error: r, errorMessage: n } = u(e);
  return {
    value: e,
    onChange: t,
    error: r,
...
function App() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { children: [
    ...
    Object.entries(cardInformation).map(([label, field]) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "form-group", children: [
